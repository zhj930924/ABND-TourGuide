 ...
 */
public class MuseumReviewFragment extends Fragment {

    public MuseumReviewFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reviewTextView.setText(R.string.museum_review);

        TextView reviewerTextView = (TextView) rootView.findViewById(R.id.review_reviewer);
        reviewerTextView.setText(R.string.museum_reviewer);
