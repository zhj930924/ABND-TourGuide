...
public class AttractionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager mLayoutManager = new LinearLayoutManager(AttractionActivity.this);
    ...
    private void goToAttraction(String attractionName) {
        Intent attractionIntent = new Intent(AttractionActivity.this, AttractionActivity.class);
        if (attractionName == getString(R.string.bund_title)) {
            attractionIntent = new Intent(AttractionActivity.this, BundActivity.class);
        } else if (attractionName == getString(R.string.museum_title)) {
            attractionIntent = new Intent(AttractionActivity.this, MuseumActivity.class);
        } else if (attractionName == getString(R.string.zoo_title)) {
            attractionIntent = new Intent(AttractionActivity.this, ZooActivity.class);
        } else if (attractionName == getString(R.string.yu_garden_title)) {
            attractionIntent = new Intent(AttractionActivity.this, YuGardenActivity.class);
        } else if (attractionName == getString(R.string.train_title)) {
            attractionIntent = new Intent(AttractionActivity.this, TrainActivity.class);
        }
